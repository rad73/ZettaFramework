...
RedactorPlugins.fontcolor = {
	init: function()
	{
		...
		for (var i = 0; i < 2; i++)
		{
			...
			var $dropdown = $('<div class="redactor_dropdown redactor_dropdown_box_' + name + '" style="display: none; margin-left: -121px; width: 243px;">');

			this.pickerBuild($dropdown, name, colors);
			$(this.$toolbar).append($dropdown);

			(function (_this, $dropdown) {

				_this.buttonAdd(name, _this.opts.curLang[name], $.proxy(function(btnName, $button, btnObject, e)
				{
