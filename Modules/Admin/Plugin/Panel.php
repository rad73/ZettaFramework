...
class Modules_Admin_Plugin_Panel extends Zend_Controller_Plugin_Abstract {
	...
	public function routeStartup(Zend_Controller_Request_Abstract $request) {
		...
		$this->_view->headScript()
			...
			//->appendFile($this->_view->libUrl('/Editor/public/js/imperavi/plugins/fullscreen/fullscreen.js'))
			->appendFile($this->_view->libUrl('/Editor/public/js/imperavi/plugins/undo/undo.js'))
