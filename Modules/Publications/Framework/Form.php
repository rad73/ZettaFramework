...
class Modules_Publications_Framework_Form extends Zetta_Form
{
    ...
    public function getPostData()
    {
        foreach ($this->_fields as $field) {
            if ($field['type'] == 'date' || $field['type'] == 'datetime') {
                ...
                if (sizeof($parse_date['errors']) > 0) {
                    $arrayData[ $field['name'] ] = false;
                } else {
            ...
            } elseif ($field['type'] == 'multiCheckbox' && sizeof($this->getValue($field['name']))) {
    ...
    protected function _addElements()
    {
        ...
        foreach ($fields as $i => $field) {
            ...
            if (!ZETTA_FRONT && $field->hidden_admin) {
                continue;
            }
